...
## process
---
Syntax:<p class="alert alert-info">process main{ }<br/>process sub{ }</p>
定义一个过程，包括主过程与子过程。
...
## return
---
Syntax:<p class="alert alert-info">return [[expression]];</p>
...
## for...in
---
Syntax:<p class="alert alert-info">for (variable in object){ }</p>
...
## for...of
---
Syntax:<p class="alert alert-info">for (variable of object){ statement }</p>
...
## if...else
---
Syntax:<p class="alert alert-info">if (condition)<br/>statement1<br/>[else<br/>statement2]</p>
...
## continue
---
Syntax:<p class="alert alert-info">continue;</p>
...
## while
---
Syntax:<p class="alert alert-info">while (condition)<br/> statement</p>
...
## log
---
Syntax:<p class="alert alert-info">log [expression,variable,string];</p>
